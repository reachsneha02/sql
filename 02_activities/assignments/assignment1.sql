...
SELECT vendor_id, COUNT(booth_number) as count_booth_rent
...
SELECT customer_id, strftime('%m', market_date) AS month, strftime('%Y', market_date) AS year, SUM(quantity * cost_to_customer_per_qty)
FROM customer_purchases
